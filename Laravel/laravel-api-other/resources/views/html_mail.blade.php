...
<table border="0" cellpadding="0" cellspacing="0" class="tbl1">
    <tr style="vertical-align: middle;">
        <td colspan="2" style="width: 100%;text-align: center">
            <span style="color:#03386F;font-size:50px;">LearnVern</span>
        </td>
    </tr>
    ...
    <tr style="text-align: center;">
        <td colspan="2" style="height:62px; margin:0px;">
            <p style="font-size: 16px; line-height: 20px; margin:0px;">
                <span style="font-family: helvetica, arial, sans-serif; font-weight: bolder; color:#FFC000;font-size: 21px; font-weight: 100; line-height: 48px; margin: 0px;">100% FREE LEARNING PORTAL.</span>
                <br>
                <span  style="font-size: 19px; font-weight: 100; line-height: 30px; margin: 0px;font-family: helvetica, arial, sans-serif; color: #03386F;"> {{ __('message.tagline') }} </span><br>
            </p>
        </td>
    </tr>
