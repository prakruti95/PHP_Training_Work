...
Route::post('queue', [\App\Http\Controllers\UserController::class, 'queue'])->name('queue');

// Executing Commands Programatically
Route::get('exceuteCommand', [\App\Http\Controllers\UserController::class, 'exceuteCommand']);
Route::get('exceuteCommandWithBinding/{users}', [\App\Http\Controllers\UserController::class, 'exceuteCommandWithBinding']);
