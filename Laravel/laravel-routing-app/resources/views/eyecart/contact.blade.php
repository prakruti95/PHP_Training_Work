	...
	<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
		<div class="container">
			...
			<div class="inner_sec">
				...
				<p class='sub text-center mb-lg-5 mb-3'>
...
@endif
					...
					<form  method="post">
						...
						<div class="row contact_left_grid">
							...
							<div class="col-md-6 con-right">
								<div class="form-group">
									<label>Message</label>
									<textarea id="textarea" name="Message" placeholder="" class="form-control"></textarea>
								</div>
                                </div>
								<div class="col-md-5">
								
								<input  type="submit" value="Send" class="btn btn-md bg-dark text-white">
								<input  type="reset" value="Reset" class="btn btn-md bg-danger text-white">
                              </div>
	...
	<div class="contact-map">
		...
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100949.24429313939!2d-122.44206553967531!3d37.75102885910819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan+Francisco%2C+CA%2C+USA!5e0!3m2!1sen!2sin!4v1472190196783"
		    class="map" style="border:0; width:90% ; margin-left:5%" allowfullscreen=""></iframe>
	</div>
