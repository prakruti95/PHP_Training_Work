							...
							<div class="col-lg-4 single-right-left ">
									<div class="grid images_3_of_2">
										<div class="flexslider1">
											...
											<ul class="slides">
												<li data-thumb="{{ asset('assets/eye/customer/images/d2.jpg')}}">
													<div class="thumb-image"> <img src="{{ asset('assets/eye/customer/images/d2.jpg')}}" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
